...
SELECT MAX(client_id) AS max_client 
FROM client 
...
SELECT district_id, COUNT(district_id) AS total_clients
FROM client
...
-- (VYDAJ = Outgoing, PRIJEM = Incoming). Your output should have the account_id, the type and the sum 
